...
// @downloadURL  https://github.com/sffxzzp/userscripts/raw/master/HumbleChoiceKeyTools/HCKT.user.js
// ==/UserScript==
            ...
            document.querySelector('#hckt_revealAll').onclick = function () {
                ...
                for (var l=0;l<content.length;l++) {
                    if (choosed.indexOf(content[l].selName) >= 0) {
                        const data = new URLSearchParams({ keytype: content[l].rawName, key: gameKey, "keyindex": 0});
